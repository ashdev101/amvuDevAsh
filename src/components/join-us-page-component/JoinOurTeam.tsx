import { ApplyNow } from "../../utils/join-us-utils/images"
import "../../styles/join-us-styles/joinOurTeam.css"
const JoinOurTeam = () => {
    return (
        <div className='mt-[30px] mb-[40px]'>
            <h2 className='join-us-all-headings'>Join Our Team as Intern</h2>
