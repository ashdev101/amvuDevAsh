...
const ServicesTop = () => {
  return (
    <div className="services-top-container">
      ...
      {/*  Wave Second  */}
      <svg xmlns="http://www.w3.org/2000/svg" width="1488" height="405" viewBox="0 0 1488 405" fill="none" className="absolute 2xl:bottom-[-50px] xl:bottom-[-100px] md:bottom-[-150px] sm:bottom-[-170px] bottom-[-209px] h-[500px] bg-inherit w-full">
