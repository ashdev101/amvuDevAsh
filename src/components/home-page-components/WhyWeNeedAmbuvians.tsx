            ...
            <div className="flex flex-col xl:mt-[120px] mt-[10px] xl:h-full h-[700px] relative">
                ...
                <div className="flex xl:flex-row flex-col-reverse justify-evenly">
                    <div className={"h-full flex justify-between items-baseline 2xl:w-[38%] xl:w-[44%] w-[38%]"} ref={imgRef}>
                        <img src={Traffic} alt="traffic" className={clsx("whyWeNeedAmbuvians-traffic-image", imgInView ? "animate-fadein-image" : "animate-fadeout")} />
                        <img src={Patient1} alt="patient" className={clsx("whyWeNeedAmbuvians-patient1-image", imgInView ? "animate-fadein-image" : "animate-fadeout")} />
                    </div>
                ...
                <div className={clsx("flex justify-evenly mt-[50px] 2xl:w-[80%] xl:w-[90%] w-[80%] m-auto")}>
                    <img src={PatientOnBike} alt="patient" className={clsx("whyWeNeedAmbuvians-patientOnBike-image", imgInView ? "animate-fadein-image" : "animate-fadeout")} />
                    <img src={Patient2} alt="patient" className={clsx("whyWeNeedAmbuvians-patient2-image", imgInView ? "animate-fadein-image" : "animate-fadeout")} />
                </div>
            </div>

            {/* Vactors */}
            <div>
                <img src={Vactor3} className={clsx("whyWeNeedAmbuvians-vactor3")} />
                <img src={Vactor4} className={clsx("whyWeNeedAmbuvians-vactor4")} />
            </div>
