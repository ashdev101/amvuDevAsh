...
const CampusAmbassadorAbout = () => {
    return (
        <div className='mt-[30px]'>
            <h2 className='campus-all-headings'>About</h2>
            <p className=' text-justify w-[90%] m-auto  font-[400] mt-[20px] xl:text-[18px] lg:text-[16px] md:text-[14px] sm:text-[12px] text-[10px]'>
