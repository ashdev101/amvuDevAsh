...
import { RegisterMutation, VerifyPaymentMutation } from '../ApiCalling/mutations';
import { DonationFormInputTypes } from '../../d.tyes'
import { useDispatch } from 'react-redux';
import Captcha from '../components/Captcha/Captcha';
import { IoIosRefresh } from 'react-icons/io';
import VerifyOtpForDonationModal from '../components/Modal/VerifyOtpForDonation';
import PaymentForDonationModal from '../components/Modal/PaymentForDonation';
...
function Donation(): JSX.Element {
    ...
    const mutationForRegisterForPayer = VerifyPaymentMutation();
    ...
    const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
        ...
        //make mutation
        mutationForRegisterForPayer.mutate({
    ...
    return (
        <>
            <VerifyOtpForDonationModal />
            <PaymentForDonationModal />

            <main className=' relative z-[50] h-screen w-full flex flex-row justify-center'>
                ...
                <section className='w-[90%] md:w-[80%] lg:w-[60%] h-full flex flex-col px-6 gap-1'>
                    ...
                    <span>Give a Little, Change a Lot: Donate Today!!</span>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className='w-full'>
                        ...
                        <section className='w-full flex flex-col sm:flex-row items-center justify-center mt-4 gap-3'>
                            <LoginButton type='submit' isDisabled={isButtonDisabled} label='Send Otp' />
